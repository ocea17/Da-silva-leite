...
const realisations = ref([
  ...
  { title: 'Aménagement d\'intérieur',     location: 'Mantes-la-Jolie (78)',      category: 'Aménagement', imgBefore: '/photo/realisations/renovation6_avant.jpeg', imgAfter: '/photo/realisations/renovation6_apres.webp', desc: 'Isolation : placo, doublage polystyrène, peinture, papier peint et menuiserie (rebords de fenêtre) pour le confort thermique et acoustique.',                                                                                               showAfter: false },
